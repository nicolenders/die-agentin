...
const ICONS: Record<string, ReactNode> = {
  ...
  email: (
    <path d="M2 4h20a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm10 7L2.4 5.5a.5.5 0 0 0-.4.9l9.7 5.6a.6.6 0 0 0 .6 0l9.7-5.6a.5.5 0 0 0-.4-.9L12 11z" />
  ),
};
