...
const de = {
  ...
  sightings: {
    ...
    filter: "Nach Jahr oder Kanal filtern",
    reset: "Filter zurücksetzen",
    noMatch: "Zu dieser Auswahl gibt es nichts.",
    filterYear: "Jahr",
    filterChannel: "Kanal",
    all: "Alle",
  ...
  dispatch: {
    ...
    yearAll: "Alle Jahre",
    searchLabel: "Depeschen durchsuchen",
    searchPlaceholder: "Suchen (Titel, Thema, Identität) …",
    searchSubmit: "Suchen",
