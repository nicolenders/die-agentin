...
async function main() {
  ...
  // --- Speaker-Kit-Bios (Anhang A.1) ----------------------------------------
  // ENTWURF — von Nicole zu prüfen. ⚠-Stellen sind bewusst im Text belassen
  // (TODO(nicole) in docs/PROGRESS.md). Dritte Person (Veranstalter übernehmen
  // Bios so). Als SiteSettings gepflegt (bio.<len>.<locale>).
  const bios: Record<string, string> = {
    "bio.short.de":
      "ENTWURF — Nicole Enders ist Microsoft MVP, siebenmal in Folge seit 2020, und Autorin von zehn Fachbüchern zu SharePoint, Microsoft Teams und Microsoft 365. Sie arbeitet an der Grenze zwischen Konfiguration und Entwicklung — von Information Architecture bis zu Agents mit Copilot Studio und Microsoft Foundry. Auf Konferenzen ist sie regelmäßig als Speakerin unterwegs.",
    "bio.short.en":
      "ENTWURF — Nicole Enders is a Microsoft MVP, awarded seven years running since 2020, and the author of ten technical books on SharePoint, Microsoft Teams and Microsoft 365. She works on the line between configuration and code — from information architecture through to agents built with Copilot Studio and Microsoft Foundry. She speaks regularly at conferences across Europe. ⚠ Reichweite „across Europe“ gegen die tatsächliche Einsatzhistorie prüfen.",
    "bio.medium.de":
      "ENTWURF — Nicole Enders ist Microsoft MVP — siebenmal in Folge seit 2020 — und beschäftigt sich seit über fünfzehn Jahren mit Zusammenarbeit in Unternehmen. ⚠ Arbeitgeber und Rolle ergänzen.\n\nIhre Themen bauen aufeinander auf: Information Architecture in SharePoint, Modern Work mit Microsoft Teams und Microsoft 365, Low Code auf der Power Platform, und heute Agents mit Microsoft 365 Copilot, Copilot Studio und Microsoft Foundry. Dazu kommt KI in der Softwareentwicklung, bewusst herstellerübergreifend.\n\nSie hat zehn Fachbücher bei Rheinwerk geschrieben und Kurse für LinkedIn Learning produziert. Sessionize hat sie viermal in Folge als Most Active Speaker ausgezeichnet.\n\nAuf der Bühne interessiert sie weniger die Demo als die Frage dahinter: Was muss vorhanden sein, damit die Technik im Alltag trägt? Ein Copilot ist so gut wie die Informationsarchitektur, auf der er sitzt.",
    "bio.medium.en":
      "ENTWURF — Nicole Enders is a Microsoft MVP, awarded seven years running since 2020, and has spent more than fifteen years working on collaboration in organisations. ⚠ Add employer and role.\n\nHer topics build on one another: information architecture in SharePoint, modern work with Microsoft Teams and Microsoft 365, low code on the Power Platform, and today agents built with Microsoft 365 Copilot, Copilot Studio and Microsoft Foundry. Alongside that, she works on AI in software development — deliberately vendor-neutral.\n\nShe has written ten technical books for Rheinwerk and produced courses for LinkedIn Learning. Sessionize has named her a Most Active Speaker four years running.\n\nOn stage she is less interested in the demo than in the question behind it: what has to be in place for the technology to hold up in daily work? A Copilot is only as good as the information architecture it sits on.",
    "bio.long.de":
      "ENTWURF — Nicole Enders ist Microsoft MVP und wurde seit 2020 siebenmal in Folge ausgezeichnet. Seit über fünfzehn Jahren beschäftigt sie sich mit der Frage, wie Zusammenarbeit in Unternehmen tatsächlich funktioniert — nicht als Produktvorführung, sondern als Architektur- und Adoptionsfrage. ⚠ Arbeitgeber und Rolle ergänzen.\n\nIhre Themen sind kein Nacheinander, sondern ein Stack. Sie hat Intranets und Collaboration-Lösungen auf SharePoint gebaut, lange bevor Information Architecture ein KI-Thema wurde. Sie hat den Umstieg auf Microsoft Teams und Microsoft 365 begleitet, auf Anwender- wie auf Entwicklerseite. Sie arbeitet mit der Power Platform, wo die Grenze zwischen Konfiguration und Code verhandelbar wird. Und sie baut heute Agents mit Microsoft 365 Copilot, Copilot Studio und Microsoft Foundry — auf denselben Fundamenten, die sie seit Jahren kennt. Dazu kommt seit Kurzem KI in der Softwareentwicklung, bewusst herstellerübergreifend.\n\nWas diese Themen verbindet, ist eine Grenze, die sich immer wieder verschiebt: die zwischen Konfigurieren und Entwickeln. Auf dieser Grenze arbeitet Nicole seit fünfzehn Jahren — und deshalb ist die Breite ihrer Themen keine Beliebigkeit, sondern Tiefe über den ganzen Stack.\n\nIhr Wissen gibt sie in Büchern, Kursen und auf Konferenzen weiter. Bei Rheinwerk sind zehn Titel von ihr erschienen, darunter „Microsoft Teams: Die verständliche Anleitung“ in dritter Auflage. Für LinkedIn Learning hat sie Kurse zur Teams-Entwicklung produziert. Sessionize hat sie viermal in Folge als Most Active Speaker ausgezeichnet. Neben ihren Microsoft-Zertifizierungen ist sie u. a. iSAQB Certified Professional for Software Architecture.\n\nIn ihren Sessions geht es selten nur um Features. Häufiger um die Frage, was vorhanden sein muss, damit Technik im Arbeitsalltag trägt: Berechtigungen, Struktur, Governance, Akzeptanz. Ein Copilot ist so gut wie die Informationsarchitektur, auf der er sitzt — und die entsteht nicht von selbst.",
    "bio.long.en":
      "ENTWURF — Nicole Enders is a Microsoft MVP, awarded seven years running since 2020. For more than fifteen years she has worked on the question of how collaboration in organisations actually works — not as a product demo, but as a matter of architecture and adoption. ⚠ Add employer and role.\n\nHer topics are not a sequence but a stack. She built intranets and collaboration solutions on SharePoint long before information architecture became an AI topic. She guided the move to Microsoft Teams and Microsoft 365, for users and developers alike. She works with the Power Platform, where the line between configuration and code becomes negotiable. And today she builds agents with Microsoft 365 Copilot, Copilot Studio and Microsoft Foundry — on the same foundations she has known for years. Recently, AI in software development has been added, deliberately vendor-neutral.\n\nWhat connects these topics is a line that keeps shifting: the one between configuring and developing. Nicole has worked on that line for fifteen years — which is why the breadth of her topics is not arbitrariness but depth across the whole stack.\n\nShe shares her knowledge in books, courses and at conferences. Rheinwerk has published ten of her titles, including a third edition of her Microsoft Teams guide. For LinkedIn Learning she produced courses on Teams development. Sessionize named her a Most Active Speaker four years running. Alongside her Microsoft certifications she is, among others, an iSAQB Certified Professional for Software Architecture.\n\nHer sessions are rarely only about features. More often about what has to be in place for technology to hold up in daily work: permissions, structure, governance, acceptance. A Copilot is only as good as the information architecture it sits on — and that does not emerge by itself.",
  };
